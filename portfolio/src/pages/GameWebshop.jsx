...
function GameWebshop() {

    return (
        <motion.section
    className="gamewebshop"
...
>
            ...
            <div className="gamewebshop-hero">
            <h1>LucaStars Webshop</h1>

            <div className="gamewebshop-image"></div>
